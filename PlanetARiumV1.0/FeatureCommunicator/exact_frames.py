...
class MyHandler(http.server.BaseHTTPRequestHandler):
    ...
    def do_POST(self):
        ...
        #     data = json.loads(post_body.decode("utf-8"))
        #     logging.info('Creating connection with a new socket...')
        ...
        #     data = json.loads(post_body.decode("utf-8"))
        #     logging.info('Closing connection with socket...')
    ...
    while fps < MAX_FRAMES:
        try:
            ...
            for i in range(len(frame_senders)):
                ...
                time.sleep(3) # Godline. Permite a las tareas que se reinicien
